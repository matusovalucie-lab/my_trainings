const STORAGE_KEY = "my-trainings-v3";
...
const TEMPLATES = [
  {
    id: "workout-a",
    name: "Workout A",
    subtitle: "Hýždě + zadní stehna + core",
    sections: [
  ...
  },
  {
    id: "micro",
    name: "Micro Workout",
    subtitle: "Krátký domácí trénink",
    fixedLocation: "home",
    sections: [
      { category: "glutes", count: 1 },
      { category: "hamstrings", count: 1 },
      { category: "back", count: 1 },
...
const EXERCISES = [
  ...
  {id:"hip_abduction",name:"Unožování na stroji",category:"glutes",locations:["gym"],sets:3,reps:"12–15"},
  {id:"glute_bridge",name:"Glute bridge",category:"glutes",locations:["home"],sets:3,reps:"12–15"},
  {id:"goblet_squat",name:"Goblet dřep",category:"glutes",locations:["home","gym"],sets:3,reps:"8–12"},

  {id:"rdl",name:"Rumunský tah s jednoručkami",category:"hamstrings",locations:["home","gym"],sets:3,reps:"8–10"},
  ...
  {id:"single_rdl",name:"Jednonožní rumunský tah",category:"hamstrings",locations:["home","gym"],sets:3,reps:"8–10 / noha"},
  ...
  {id:"triceps_kickback",name:"Tricepsový kickback",category:"arms",locations:["home","gym"],sets:3,reps:"10–12"},
  ...
  {id:"farmer_carry",name:"Farmářská chůze",category:"core",locations:["home","gym"],sets:3,reps:"30–50 m"},

  {id:"reverse_lunge",name:"Výpad vzad",category:"legs",locations:["home","gym"],sets:3,reps:"8–10 / noha"},
  {id:"leg_press",name:"Leg press",category:"legs",locations:["gym"],sets:3,reps:"8–12"},
  {id:"step_down",name:"Kontrolovaný sestup z lavičky",category:"legs",locations:["home","gym"],sets:3,reps:"8–10 / noha"},
  {id:"split_squat",name:"Dělený dřep",category:"legs",locations:["home","gym"],sets:3,reps:"8–10 / noha"},
